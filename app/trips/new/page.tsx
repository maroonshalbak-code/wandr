  ...
  return (
    <MobileShell>
      <div className="flex items-center gap-3 px-5 pt-2 pb-3 flex-shrink-0">
        <BackButton href="/" />
        <h1 className="text-xl font-semibold text-gray-900 flex-1">New trip</h1>
      </div>
      ...
      <div className="flex-1 overflow-y-auto px-4 pb-8">
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-4">
            <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-3">Icon</p>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-4 flex flex-col gap-3">
            <div>
              <label className="text-xs font-medium text-gray-500 mb-1 block">Trip name *</label>
              <input
                type="text"
                value={name}
          ...
          {name && (
            <div className="flex items-center gap-3 bg-white border border-gray-100 rounded-2xl p-3.5">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400">{destination || 'Destination TBD'}</p>
              </div>
            </div>
          )}
