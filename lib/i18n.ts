...
const t: Record<SupportedLocale, Record<string, string>> = {
  en: {
    ...
    tripName: 'Trip name',
    tripNamePlaceholder: 'e.g. Summer in Bali',
    ...
    phoneOptional: 'Phone (optional, for WhatsApp)',
    // Trip delete
  ...
  ar: {
    ...
    tripName: 'اسم الرحلة',
    tripNamePlaceholder: 'مثال: صيف في بالي',
    destination: 'الوجهة',
    destinationPlaceholder: 'دولة أو مدينة',
    destinationTbd: 'الوجهة غير محددة',
    iconLabel: 'الأيقونة',
    colorLabel: 'اللون',
    type: 'النوع',
    noPlans: 'لا خطط بعد',
    ...
    phoneOptional: 'الهاتف (اختياري، للواتساب)',
    // Trip delete
  ...
  he: {
    ...
    tripName: 'שם הטיול',
    tripNamePlaceholder: 'למשל: קיץ בבאלי',
    destination: 'יעד',
    destinationPlaceholder: 'מדינה או עיר',
    destinationTbd: 'יעד טרם נקבע',
    iconLabel: 'אייקון',
    colorLabel: 'צבע',
    type: 'סוג',
    ...
    inviteAction: '✉ הזמן',
    viaEmail: 'במייל',
    viaWhatsApp: 'בוואטסאפ',
    phoneOptional: 'טלפון (אופציונלי, לוואטסאפ)',
    // Trip delete
    deleteTrip: 'מחק טיול',
